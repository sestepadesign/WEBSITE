...
export interface Project {
  ...
  /** Social preview image (JPG, �0�1MB). Falls back to cover when omitted. */
  ogImage?: string;
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Die breiten, einfach gestalteten Stufen bilden eine Hauptverkehrsachse, die den Eingangsbereich mit den oberen Terrassen verbindet, während seitliche Sockel und Hochbeete den Boden stützen und Bepflanzungen aufnehmen, die den �Sbergang zwischen den Ebenen abmildern.",
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Beim Betreten des Gartens wird man von zwei zentralen Wegen empfangen, die mit Lippia (<i>Phyla nodiflora</i>) bepflanzt sind und als starke Sichtachsen dienen. Am Ende dieser Wege erhebt sich ein majestätischer Ombú-Baum (<i>Phytolacca dioica</i>). Entlang der Zufahrtsstra�xe zum Anwesen wurden Lippia und rot blühende Prachtkerzen (<i>Gaura lindheimeri</i>) verwendet, wodurch ein lebendiger und einladender Eingangsbereich entsteht.",
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Zusammenfassend lag unser Hauptaugenmerk darauf, den Wasserverbrauch zu reduzieren, indem wir den Rasen eliminierten und gleichzeitig Fu�xgängerwege zwischen den Pflanzen anlegten, um die Schönheit und Ruhe der Grünfläche voll und ganz zu genie�xen."
      ]
    }
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Wir haben das Wachstum hoher Pflanzen vermieden, um von jedem Punkt aus einen vollständigen �Sberblick zu erhalten. Vom Poolbereich aus genie�xen die Gäste einen weiten Panoramablick, bei dem verschiedene Farben und Höhen in perfekter Harmonie ineinander übergehen."
      ]
    }
  },
  {
    ...
    de: {
      ...
      description: [
        "Im Garten von Llubí konzentriert sich unser Landschaftsentwurf auf einen ästhetischen, funktionalen und nachhaltigen Raum. Wir haben der Wassereinsparung Priorität eingeräumt und auf Rasenflächen zugunsten einer gro�xen Kieszone verzichtet.",
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Um das Haus herum geht der Garten allmählich in die natürliche Landschaft über. Die äu�xeren Ränder des Grundstücks werden in ein traditionelles mallorquinisches Feld verwandelt, das sich nahtlos in die Umgebung einfügt. Der Prozess beginnt mit dem Beschneiden der vorhandenen Vegetation und dem Ausräumen des Bodens, um ihn für die Neupflanzung vorzubereiten.",
        "Ein Schlüsselkonzept besteht darin, das Haus vor dem Eingang zu verstecken, so dass es am Ende des Weges als �Sberraschung aus der Vegetation auftaucht. Hundertjährige Olivenbäume (<i>Olea europaea</i>) werden an strategischen, unregelmä�xigen Stellen gepflanzt, um die Landschaft zu verankern. Ergänzend dazu erheben sich unregelmä�xige Zypressen (<i>Cupressus sempervirens</i>) über den Rest der Vegetation, die sowohl eine toskanische als auch eine mallorquinische Atmosphäre hervorrufen.",
        "Für die grö�xeren Freiflächen schlagen wir lockere, aber gro�xzügige Gruppierungen trockenheitstoleranter Arten vor, wie z.B.: <i>Lavandula dentata</i>, <i>Rosmarinus officinalis</i> 'Prostratus', <i>Perovskia atriplicifolia</i>, <i>Gaura lindheimeri</i>, <i>Leucophyllum</i>, <i>Teucrium fruticans</i>, <i>Pistacia lentiscus</i>, und <i>Westringia fruticosa</i>. Diese Gruppen werden natürliche Korridore im Garten bilden, die zu entspannten Spaziergängen einladen und ein intensives Erlebnis bieten. Die Wege werden sich diskret in das Gesamtdesign einfügen und eine natürliche, entspannte und harmonische Atmosphäre schaffen. In bestimmten Bereichen wird sich die Vegetation leicht öffnen und kleine, einladende Plätze bilden, an denen man sitzen und die Umgebung genie�xen kann.",
      ]
    }
  },
  {
    ...
    de: {
      ...
      description: [
        "Bei dem Projekt für diese Terrasse in Santa Eugènia haben wir verschiedene Ma�xnahmen ergriffen, um die Vegetation zu integrieren und die Präsenz des vorherrschenden Betons zu mildern. Wir haben gro�xe Pflanzgefä�xe in verschiedenen Höhen entlang der Terrasse aufgestellt. Diese Pflanzgefä�xe enthalten Pflanzen in verschiedenen Farbtönen und mit unterschiedlichen Blüten, die aufgrund ihrer bodenbedeckenden Eigenschaften und ihrer Fähigkeit, den Boden vollständig zu bedecken, ausgewählt wurden. Das Ziel ist es, grüne Flecken zu schaffen, die der Terrasse Leben und Farbe verleihen.",
        "Bei der Treppe haben wir die zentrale Treppe frei gelassen und auf jeder Seite Pflanzgefä�xe auf verschiedenen Ebenen aufgestellt.",
        "Neben dem Pool haben wir gro�xe Blumenbeete angelegt, die die Monotonie des Betons durchbrechen und eine Insel der Vegetation schaffen, die wie eine grüne Lunge im Raum wirkt.",
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Der Entwurf zeichnet sich durch klare Linien aus strukturellen grünen Kugeln und architektonischen Palmen aus, die einen Dialog von Licht und Schatten vor wei�xen Steinfassaden herstellen.",
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        "Diese Terrasse im obersten Stockwerk eines modernen Gebäudes in Palma wurde in einen bewohnbaren Garten umgewandelt, indem dauerhaftes Grün, klimatischer Komfort und eine an die Architektur angepasste �sthetik integriert wurden.",
        "Die Intervention beruht auf einer sensiblen Betrachtung des Standorts: Sonnenausrichtung, Windexposition und Ausblicke auf Meer und Stadt. Das Design ist um gro�xformatige, lineare Pflanzgefä�xe herum strukturiert, die funktionale Zonen abgrenzen.",
        ...
        "Gro�xformatige Porzellanplatten in hellen Steintönen und Möbel mit klaren Linien ergänzen die Bepflanzung. Die ausgewählten Arten bieten hohe Widerstandsfähigkeit gegen Wind und Sonne, geringen Wasserbedarf und minimalen Schnittaufwand."
      ]
    }
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Das Projektvorschlag besteht aus zwei vertikalen Gärten mit unterschiedlichen geometrischen Strukturen, innen und au�xen. Lichtstrahlen dringen in den Innenraum ein und erzeugen einen Dschungellichteffekt entlang der gesamten Au�xenfassade.",
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Entlang des Weges bieten Pflanzgefä�xe Höhenperspektiven: kleinere Sträucher vorne, grö�xere hinten, ergänzt durch strategisch platzierte Wildblumen, die die Beete nicht verdecken."
      ]
    }
  },
  {
    ...
    de: {
      ...
      subtitle: "Ein Garten zum Durchwandern, Entdecken und Genie�xen auf einem Längsgrundstück",
      category: "Wohnbereich Garten",
      botanical: "Grevillea robusta, Lippia nodiflora, Lavandula dentata, Perovskia atriplicifolia, Limonium perezii, Stachys byzantina, Rosa Iceberg, Pennisetum alopecuroides, Teucrium fruticans, Stipa tenuissima, Muhlenbergia capillaris, Gaura lindheimeri",
      description: [
  ...
  },
  {
    ...
    de: {
      ...
      description: [
        ...
        "Wir haben darauf geachtet, dass die Farben in diesen Räumen durch ihre Intensität und ihren Kontrast hervorstechen: intensive Grün-, Flieder-, Blau-, Gelb- und Wei�xtöne. Auf diese Weise wurde der Garten vor allem im Sommer und Frühjahr zu einem kontrastreichen Farbenspiel.",
        ...
        "Bei der Gestaltung dieses Gartens wurden visuelle und funktionale Elemente erfolgreich miteinander kombiniert, so dass ein reizvoller und harmonischer Raum entstand, in dem man sich am Meer erholen und die Schönheit der Natur genie�xen kann."
      ]
    }
  }
];
