...
export interface ProjectClient {
  name: string;
  type: "Hotel" | "Organization" | "LocalBusiness";
  sameAs?: string;
}
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    en: {
      ...
      description: [
        "The Campos Garden is an impressive 14,000 m² landscape designed and built by S’Estepa. Every corner of this garden has been carefully planned to provide a unique and enjoyable visual experience.",
    ...
    es: {
      ...
      botanical: "Phyla nodiflora, Phytolacca dioica (Bellasombra), Gaura lindheimeri, Rosmarinus officinalis 'Prostratus', Lantana camara, Lantana montevidensis, Bougainvillea sanderiana, Agapanthus africanus, Stipa tenuissima, Phoenix roebelenii, Cupressus arizonica, Pittosporum tobira 'Nana'",
      description: [
        "El Jardín de Campos es un impresionante espacio de aproximadamente 14.000 m², diseñado y montado por S’Estepa. Cada rincón de este jardín ha sido cuidadosamente planificado para ofrecer una experiencia visual única y agradable.",
    ...
    de: {
      ...
      botanical: "Phyla nodiflora, Phytolacca dioica (Bellasombra), Gaura lindheimeri, Rosmarinus officinalis 'Prostratus', Lantana camara, Lantana montevidensis, Bougainvillea sanderiana, Agapanthus africanus, Stipa tenuissima, Phoenix roebelenii, Cupressus arizonica, Pittosporum tobira 'Nana'",
      description: [
        "Der Garten von Campos ist eine beeindruckende, rund 14.000 m² große Gartenanlage, die von S’Estepa entworfen und umgesetzt wurde. Jeder Bereich dieses Gartens wurde sorgfältig geplant, um ein einzigartiges und angenehmes visuelles Erlebnis zu schaffen.",
  ...
  },
  {
    ...
    client: {
      ...
      type: "Hotel",
      sameAs: "https://www.cabot-hotels.com/es/cabot-las-velas-apartamentos/"
    },
    year: "2022",
    architect: null,
    video: null,
  ...
  },
  {
    ...
    images: [
      ...
      "2026-09-4-months/garden-design-mallorca-sant-llorenc-4-months-01-sestepa-design.webp",
      "2026-09-4-months/garden-design-mallorca-sant-llorenc-4-months-02-sestepa-design.webp",
      ...
      "garden-design-mallorca-sestepa-landscape-design-sant-llorenc-06.webp",
    ...
    galleryChapters: [
      {
        ...
        photos: [
          "garden-design-mallorca-sant-llorenc-4-months-01-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-02-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-03-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-04-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-05-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-06-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-07-sestepa-design.webp",
          "garden-design-mallorca-sant-llorenc-4-months-08-sestepa-design.webp"
        ],
        en: {
          ...
          imageAlts: [
            "Sant Llorenç garden four months after planting: olive tree and gaura meadow - S'Estepa Design",
            "Entrance path lined with rosemary, lavender and Stipa grasses - S'Estepa Design",
            "Olive tree rising from drifts of flowering gaura in Sant Llorenç, Mallorca - S'Estepa Design",
            "Olive tree and young Mediterranean planting at the country house - S'Estepa Design",
            "Curving drift of white gaura beside an olive tree - S'Estepa Design",
            "Country house seen across a meadow of flowering gaura - S'Estepa Design",
            "Pool terrace surrounded by a naturalistic garden of drought-tolerant grasses - S'Estepa Design",
            "View across the pool to the Mallorcan countryside - S'Estepa Design"
          ]
        },
        es: {
          ...
          imageAlts: [
            "Jardín de Sant Llorenç cuatro meses después de la plantación: olivo y pradera de gaura - S'Estepa Design",
            "Camino de entrada bordeado de romero, lavanda y Stipa - S'Estepa Design",
            "Olivo entre masas de gaura en flor en Sant Llorenç, Mallorca - S'Estepa Design",
            "Olivo y plantación mediterránea joven en la casa de campo - S'Estepa Design",
            "Curva de gaura blanca junto a un olivo - S'Estepa Design",
            "Casa de campo vista a través de una pradera de gaura en flor - S'Estepa Design",
            "Terraza de la piscina rodeada de un jardín naturalista de gramíneas - S'Estepa Design",
            "Vista sobre la piscina hacia el campo mallorquín - S'Estepa Design"
          ]
        },
        de: {
          ...
          imageAlts: [
            "Garten in Sant Llorenç vier Monate nach der Pflanzung: Olivenbaum und Gaura-Wiese - S'Estepa Design",
            "Eingangsweg mit Rosmarin, Lavendel und Stipa - S'Estepa Design",
            "Olivenbaum inmitten blühender Gaura in Sant Llorenç, Mallorca - S'Estepa Design",
            "Olivenbaum und junge mediterrane Bepflanzung am Landhaus - S'Estepa Design",
            "Geschwungenes Band aus weißer Gaura neben einem Olivenbaum - S'Estepa Design",
            "Landhaus hinter einer Wiese aus blühender Gaura - S'Estepa Design",
            "Poolterrasse inmitten eines naturnahen Gartens aus Ziergräsern - S'Estepa Design",
            "Blick über den Pool in die mallorquinische Landschaft - S'Estepa Design"
          ]
        }
      }
    ],
  ...
  },
  {
    ...
    images: [
      ...
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-10.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-12.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-03.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-04.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-05.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-06.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-07.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-08.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-09.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-01.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-11.webp",
      "landscape-garden-design-mallorca-sestepa-landscape-design-jardin-mediterraneo-02.webp"
    ],
    en: {
  ...
  },
  {
    ...
    location: "Mallorca",
    client: {
      name: "Vertical Garden Mallorca",
      type: "Organization",
      sameAs: "https://verticalgardenmallorca.com"
    },
    year: "2023",
