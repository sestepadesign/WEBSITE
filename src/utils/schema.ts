...
export function getLocalizedSchema(
  ...
  const organization = {
    ...
    "legalName": "S'Estepa Jardineria Integral SLU",
    ...
    "knowsAbout": [
      ...
      { "@type": "Thing", "name": "Dry Stone", "sameAs": "https://en.wikipedia.org/wiki/Dry_stone" },
      ...
      "Large Estate Landscape Architecture Mallorca",
      "Finca Garden Architecture Mallorca",
      "Luxury Villa Garden Design Mallorca",
      "Mediterranean Estate Landscaping",
      "Diseño de Jardines Mallorca",
      "Diseño de Jardines para Fincas en Mallorca",
      "Paisajismo de Grandes Fincas y Mansiones",
      "Diseño de Jardines Islas Baleares",
      "Paisajismo Mallorca",
      "Arquitectura del Paisaje Mallorca",
      "Gartengestaltung Mallorca",
      "Gartengestaltung für Fincas und Landgüter auf Mallorca",
      "Landschaftsgestaltung Mallorca",
      "Landschaftsarchitektur Balearen",
      "Dry Stone Wall Masonry (Marges de Pedra Seca)",
      "Ancient Olive Tree Heritage (Olea europaea)",
      "Sub-Surface Drip Irrigation & Water Conservation",
